...
execute if entity @e[type=#fokastudio:piglins,tag=!warped_forest_buff,predicate=fokastudio:in_warped_forest] as @e[type=#fokastudio:piglins,tag=!warped_forest_buff,predicate=fokastudio:in_warped_forest] run function fokastudio:mobs/piglin/warped_forest
