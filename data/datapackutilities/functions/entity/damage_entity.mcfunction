...
#entity type
execute if score $entity.out_0 du_data matches 1.. if entity @s[type=player] run function datapackutilities:entity/damage_player
execute if score $entity.out_0 du_data matches 1.. if entity @s[type=!player] run function datapackutilities:entity/damage_mob
