...
effect give @s[type=!#datapackutilities:undead] minecraft:instant_damage 1 0 true
effect give @s[type=#datapackutilities:undead] minecraft:instant_health 1 0 true
