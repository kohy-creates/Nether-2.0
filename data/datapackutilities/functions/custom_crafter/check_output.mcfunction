...
execute if score $crafting.out du_data matches 1 run function datapackutilities:custom_crafter/check_stacksize
...
execute if score $crafting.temp_0 du_data matches 65.. run function datapackutilities:custom_crafter/compact
