...
execute if data block -29999999 0 1601 Items[0] run function datapackutilities:custom_crafter/main_ui_clear
execute if data block -29999999 0 1601 Items[0] run function datapackutilities:custom_crafter/main_ui_move
