...
execute if block ~ ~ ~ minecraft:furnace run function #datapackutilities:recipes/furnace
execute if block ~ ~ ~ minecraft:blast_furnace run function #datapackutilities:recipes/blast_furnace
execute if block ~ ~ ~ minecraft:smoker run function #datapackutilities:recipes/smoker
