...
data merge storage datapackutilities:temp {list:[]}
data modify storage datapackutilities:temp list set from block ~ ~ ~ Items
...
data modify block ~ ~ ~ Items set from storage datapackutilities:temp list
