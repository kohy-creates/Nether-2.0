...
#modify item
data modify storage datapackutilities:temp object set from entity @s Inventory[{Slot:100b}]
...
item modify entity @s armor.feet datapackutilities:append_durability_lore
