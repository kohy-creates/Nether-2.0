...
#modify item
data modify storage datapackutilities:temp object set from entity @s Inventory[{Slot:103b}]
...
item modify entity @s armor.head datapackutilities:append_durability_lore
